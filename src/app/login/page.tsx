      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-blue-600 via-purple-600 to-pink-600 p-12 flex-col justify-between">
        <div>
          <div className="flex items-center gap-3 mb-8">
            ...
            <span className="text-2xl font-bold text-white">Excel Comparison</span>
          </div>
          ...
          <div className="mt-12 space-y-4">
            <div className="flex items-center gap-3 text-white/90">
              ...
              <span>Fuzzy matching with Jaro-Winkler & Jaccard</span>
            </div>
            <div className="flex items-center gap-3 text-white/90">
              <div className="w-8 h-8 rounded-lg bg-white/20 backdrop-blur-sm flex items-center justify-center">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <span>Process 150,000+ rows efficiently</span>
            </div>
            <div className="flex items-center gap-3 text-white/90">
              <div className="w-8 h-8 rounded-lg bg-white/20 backdrop-blur-sm flex items-center justify-center">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="text-white/70 text-sm">
          © 2026 Excel Data Comparison. All rights reserved.
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <div className="lg:hidden flex items-center gap-3 mb-8 justify-center">
            ...
            <span className="text-xl font-bold text-slate-800 dark:text-slate-200">Excel Comparison</span>
          </div>
